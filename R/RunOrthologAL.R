    ...
    if (input$species != "Custom") {
      species_lookup <- data.frame(
        Mouse = c(
          ...
          filters = 'mgi_symbol',
          filename = "/ldata/OrthologAL-code/data/ortho_df_Mouse_Human.rds"  # <--- Specific file for Mouse
        ),
        Zebrafish = c(
          ensembl_id = "drerio_gene_ensembl",
          attributes = 'zfin_id_symbol',
          filters = 'zfin_id_symbol',
          filename = "/ldata/OrthologAL-code/data/ortho_df_Zebrafish_Human.rds"      # <--- Specific file for Zebrafish
        ),
        Rat = c(
          ensembl_id = "rnorvegicus_gene_ensembl",
          attributes = 'rgd_symbol',
          filters = 'rgd_symbol',
          filename = "/ldata/OrthologAL-code/data/ortho_df_Rat_Human.rds"            # <--- Specific file for Rat
        ),
